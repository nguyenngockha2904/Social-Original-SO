...
const renderTabInfo = () => {
 ...
 <div class="tabcontent_infodetail_inf col-4">
   ...
   <div class="tabcontent_infodetail_inf col-4">
     ...
     <input class="txt_Sub" type="text" value="${userCurrent.sdt}" id="txtSdt">
   </div>
   ...
   <div class="tabcontent_infodetail_inf col-4">
     ...
     ${userCurrent.tonGiao ? `<input class="txt_Sub" type="text" value="${userCurrent.tonGiao}" id="txtTonGiao">` : ` <p class="my-2" style="font-size: 18px; color: #006eff;cursor: pointer;">
   <i class="fa fa-plus-circle" aria-hidden="true"></i> Thêm
   tôn giáo
 </p>`}
   </div>
